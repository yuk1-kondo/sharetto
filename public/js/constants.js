...
/** 手入力参加後の localStorage キー（QR 時は不要） */
export const JOIN_SESSION_KEY = 'sharetto_join_session';
export const JOIN_SESSION_EXPIRES_KEY = 'sharetto_join_expires';
export const JOIN_SESSION_DURATION_MS = 24 * 60 * 60 * 1000;
